...
namespace OCISDK
{
    ...
    public class ClientConfigBase<TKey>
    {
        ...
        /// <summary> http request connection proxy host name. </summary>
        public string ProxyHost { get; set; }

        /// <summary> http request connection proxy host port. </summary>
        ...
        public ClientConfigBase()
        {
            ...
            var resourceName = "OCISDK.Properties.endpoints.json";
